...
const AboutMeText = () => {
  return (
    <div className="flex flex-col md:items-start sm:items-center md:text-left sm:text-center">
      ...
      <p>
        I’m Wiztech, a full stack developer instructor with a passion for teaching
        and coding. I specialize in App development and full-stack web development, helping
        students build real-world projects and master modern web technologies. I
        also run a YouTube channel, Wiztech Academy, where I create tutorials and
